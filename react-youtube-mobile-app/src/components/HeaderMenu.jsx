...
export default function HeaderMenu({ headerMenu, headerLink }) {
  return (
    <header className={styles["header"]}>
      <div className={styles["header__nav"]}>
        <Link to={headerLink} className={styles["header-link"]}>
          <svg width="2rem" height="2rem" fill="none" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            <path d="M16.875 10H3.125" stroke="#0A0A0A" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M8.75 4.375L3.125 10L8.75 15.625" stroke="#0A0A0A" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </Link>
        {headerMenu}
      </div>
